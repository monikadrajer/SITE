...
@Entity
@NamedNativeQueries({
	@NamedNativeQuery(name="smtpReceiveWeeklyCounts", query = "SELECT * FROM smtpreceive_weekly_counts(?)", resultClass = SmtpWeeklyCountsEntity.class),
	@NamedNativeQuery(name="smtpSearchWeeklyCounts", query = "SELECT * FROM smtpsearch_weekly_counts(?)", resultClass = SmtpWeeklyCountsEntity.class)
})
public class SmtpWeeklyCountsEntity {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SmtpWeeklyCountsEntity other = (SmtpWeeklyCountsEntity) obj;
		if (endDate == null) {
