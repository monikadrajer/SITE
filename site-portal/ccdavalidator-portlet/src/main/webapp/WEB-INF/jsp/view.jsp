			    ...
			    <div class="panel-heading">
			      <h4 class="panel-title">
			        <a data-toggle="collapse" data-parent="#CCDAAccordion" href="#collapseCCDA1_1" tabindex="1">
			          CCDA R1.1 or MU Stage 2 Validator
			        </a>
			      </h4>
			    </div>
			      ...
			      <div class="panel-body">
				      ...
				      <div id="CCDA11">
	  					...
	  					<div id="CCDA1wrapper">
	  						<h4>Directions:</h4>
	  						<ol>
	  							<li>Please select a C-CDA document type of MU Stage 2 objective from the drop down list.</li>
    ...
    <div class="panel panel-default">
    	<div class="panel-heading"><h3 class="panel-title">Download C-CDAs for Incorporation</h3></div>
      		...
      		<ol>
      			<li>Download one or more of the CCDAs provided below and use it for incorporation into your system.</li>
