...
<%@ page import="org.sitenv.portlets.FHIR.model.TestCaseResultWrapper" %>
<%@ page import="org.sitenv.portlets.FHIR.controllers.FHIRTestCaseServlet" %>

<%
    HttpSession ps = request.getSession();
    List<TestCaseResultWrapper> testResultList = (List<TestCaseResultWrapper>)ps.getAttribute("testCaseResultList");
