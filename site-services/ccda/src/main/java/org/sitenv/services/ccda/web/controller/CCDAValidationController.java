...
public class CCDAValidationController 
{
	...
	public String validater1_1(@RequestParam(value="type_val", required=false) String type_val, @RequestParam(value="file", required=false) MultipartFile file) throws IOException  
	{
	...
	{
		return ccdaValidatorServiceManager.callCcda2_0ValidationServices(file);
	}
